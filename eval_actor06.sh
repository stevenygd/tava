...
#     engine=evaluator \
#     $ARGS_EVAL \
#     hydra.run.dir=/home/guandao/tava/pretrained/actor06


ARGS_EVAL="engine=evaluator eval_cache_dir=eval_imgs compute_metrics=true resume=true eval_per_gpu=1000 test_chunk=8192 eval_splits=['cam007_fid840']"
python launch.py \
    --config-name=mipnerf_dyn_humanrf \
    dataset=humanrf \
    dataset.subject_id=06 \
